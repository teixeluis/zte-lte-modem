define([
  ...
  function a() {
    function r(e) {
      return n.filter(m, function (n) {
        return (
          n.parent &&
          n.parent == e.hash &&
          ((n.requireLogin && i.loggedIn()) || !n.requireLogin)
        );
      });
    }
    var i = this,
    ...
    var s = n.filter(m, function (e) {
      return (
        "1" == e.level &&
        ((e.requireLogin && i.loggedIn()) || !e.requireLogin) &&
        "#login" != e.hash
      );
    });
    (i.mainMenu = e.observableArray(s)),
      (i.secondMenu = e.observableArray([])),
      i.curThirdMenu,
      (i.getThirdMenu = function (e) {
        i.curThirdMenu = r(e);
      }),
      ...
      (i.changeMenu = function (e) {
        ...
        return (
          0 == n.length
            ? t("#container").addClass("fixContainerWidth")
            : t("#container").removeClass("fixContainerWidth"),
          i.secondMenu(n),
          !0
        );
      });
  ...
  function u() {
    ...
    1 == r.level && o("two", r),
      2 == r.level && (o("three", r), h(r.hash, r.level)),
      3 == r.level &&
        (h(r.parent, r.level),
        t(".menu-three-level").removeClass("active"),
        t(".menu-three-level." + r.hash.substring(1)).addClass("active"));
  }
  function o(e, r) {
    var i = n.find(m, function (e) {
      return e.parent == r.hash && e.path == r.path;
    });
    t(".menu-" + e + "-level").removeClass("active"),
      i &&
        ("two" == e && (o("three", i), h(i.hash, e)),
        t(".menu-" + e + "-level." + i.hash.substring(1)).addClass("active"));
  }
  function h(e, r) {
    $obj = t(".menu-two-level." + e.substring(1));
    var i = ["3", "three", "2", "two"];
    (-1 != n.indexOf(i, r) && $obj.hasClass("active")) ||
  ...
  function v() {
    var e = d(),
      r = n.filter(m, function (n) {
        return (
          "1" == n.level &&
          ((n.requireLogin && e) || !n.requireLogin) &&
          "#login" != n.hash
        );
      });
    b.mainMenu(r),
  ...
  if ("CPE" == i.PRODUCT_TYPE) {
    ...
    require(["config/" + i.DEVICE + "/menu"], function (e) {
      (m = e),
        i.SD_CARD_SUPPORT &&
          (m = m.concat([
            {
